...
statistics |> ggplot(aes(x = metrics , y= values, fill = model)) +
               ...
               scale_fill_manual(values = c("Árbol" = "#84b6f4", "KNN" = "#ffca99", "Red Neuronal" = "#a2c8cc", "SVM Lineal" = "#ff8097", "SVM Poli" = "#623CEA", "Ensamblado" = "#483A58")) +
               labs(#x = "métrica", 
...
coord_equal() +
# Color
scale_colour_manual(values = c("Árbol" = "#84b6f4", "KNN" = "#ffca99", "Red Neuronal" = "#a2c8cc", "SVM Lineal" = "#ff8097", "SVM Poli" = "#623CEA", "Ensamblado" = "#483A58")) +
# Etiquetas
labs(x = "1 - Specificity",
     y = "Sensitivity",
     title = "Comparativa Modelos",
