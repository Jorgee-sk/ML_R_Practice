...
Hemos observado que nuestros datos están desbalanceados por lo que vamos a compensarlos mediante la técnica de oversampling:
...
sampsize_list <- c(100, 200, 300, 400)
```
