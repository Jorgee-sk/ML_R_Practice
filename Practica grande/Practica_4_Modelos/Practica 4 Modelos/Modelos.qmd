...
statistics |> ggplot(aes(x = metrics , y= values, fill = model)) +
               ...
               scale_fill_manual(values = c("Árbol" = "darkslategray1", "KNN" = "indianred1", "Red Neuronal" = "coral", "SVM Lineal" = "pink", "SVM Polinomial" = "darkgoldenrod1", "Ensamblado" = "darkslategray")) +
               labs(#x = "métrica", 
...
coord_equal() +
# Color
scale_colour_manual(values = c("Árbol" = "darkslategray1", "KNN" = "indianred1", "Red Neuronal" = "coral", "SVM Lineal" = "pink", "SVM Polinomial" = "darkgoldenrod1", "Ensamblado" = "darkslategray")) +
# Etiquetas
labs(x = "1 - Specificity",
     y = "Sensitivity",
     title = "Comparativa Modelos",
...
folds <- vfold_cv(attrition_train_baked, v = 5, strata = attrition, repeats = 3)
```


### Entrenamiento

Inicialmente vamos a crear un modelo que no tenga parámetros fijos para configurar nosotros estos hiperparámetros:

- Número de nodos hidden_units

- Learning rate

- Número de epochs para backpropagation

- Función de activación

- Regularización por penalización
